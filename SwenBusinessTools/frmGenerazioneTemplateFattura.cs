    ...
    public partial class frmGenerazioneTemplateFattura : Form
    {
        ...
        private void wizardOffertaEconomica_Finished(object sender, EventArgs e)
        {
            ...
            */
            ...
            {
                foreach (var footer in ((Word.Section)section).Footers)
                {

                    if (!((Word.HeaderFooter)footer).IsHeader)
                    {
                        var footerRng = ((Word.HeaderFooter)footer).Range;

                        Word.Table t2 = document.Tables.Add(footerRng, 2, 4);
                        SetTableBolders(t2);
                        ...
                        t2.Cell(1, 2).Range.InsertAfter("Tit.");
                        t2.Cell(1, 2).Range.Select();

                        //Selection.SetRange(t2.Cell(1, 3).Range.Start, t2.Cell(1, 3).Range.End);
                        Selection.TypeParagraph();
                        Selection.TypeText("Altro paragrafo ");
                        Selection.Fields.Add(Selection.Range, Word.WdFieldType.wdFieldEmpty, "FILENAME", true);


                        t2.Cell(1, 3).Range.InsertAfter("Fil\n");
                        t2.Cell(1, 3).Range.InsertAfter("Sav \n");
                        t2.Cell(1, 3).Range.InsertAfter("Aut\n");
                        

                        //var logoSwenSmall = document.InlineShapes.AddPicture(@"./Resources/Image4.jpeg", false, true);
                        //var logoShapeSmall = logoSwen.ConvertToShape();
                        //logoShapeSmall.Left = 0;
                        //logoShapeSmall.Top = 0;
                        //logoShapeSmall.TopRelative = 0;
                        //logoShapeSmall.LeftRelative = 0;
                        //logoShapeSmall.LockAspectRatio = Office.MsoTriState.msoTrue;
                        //logoShapeSmall.Width = CentimetersToPoints(2.24f);
                        //logoShapeSmall.Height = CentimetersToPoints(1.24f);
                        //logoShapeSmall.RelativeHorizontalPosition = Word.WdRelativeHorizontalPosition.wdRelativeHorizontalPositionMargin;
                        //logoShapeSmall.RelativeVerticalPosition = Word.WdRelativeVerticalPosition.wdRelativeVerticalPositionMargin;
                    }
                }
            }
